    ...
    public class BlogRepository : IBlogRepository
    {
        ...
        public ResponseListModel<BlogModel> GetBlogs(PaginationModel pagination, long categoryId = 0)
        {
            ...
            try
            {
                ...
                List<TbBlog> blogs = query.Include(blog => blog.Category).Include(blog => blog.CreatedByNavigation).Skip(pagination.PageSize * (pagination.CurrentPage - 1)).Take(pagination.PageSize).ToList();
                ...
                foreach (var blog in blogs)
                {
                    ...
                    blogModel.Comments = blogComments;
